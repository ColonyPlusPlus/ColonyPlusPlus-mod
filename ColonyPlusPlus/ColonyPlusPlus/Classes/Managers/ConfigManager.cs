...
namespace ColonyPlusPlus.Classes.Managers
{
    public static class ConfigManager
    {
        ...
        private static string getConfigStringFromNode(string[] keys, int keyIndex, JSONNode node)
        {
            ...
            {
                Utilities.WriteLog("Error getting configuration:" + keys.Count.ToString() + keyIndex.ToString() + exception.Message + exception.StackTrace);
                return "";
            }
        ...
        private static float getConfigFloatFromNode(string[] keys, int keyIndex, JSONNode node)
        {
            ...
            {
                Utilities.WriteLog("Error getting configuration:" + keys.Count.ToString() + keyIndex.ToString() + exception.Message + exception.Message);
                return 0f;
            }
