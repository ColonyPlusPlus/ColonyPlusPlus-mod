...
{
    public class QuiverJobT3 : BlockJobBase, IBlockJobBase, INPCTypeDefiner
    {
        ushort quiverType;
        Zombie target;

        public override string NPCTypeKey { get { return "cpp.guardbowt3"; } }

        public override float TimeBetweenJobs { get { return 2.0f; } }
        ...
        NPCTypeSettings INPCTypeDefiner.GetNPCTypeDefinition()
        {
            ...
            def.printName = "Bow guardLevel 3";
            def.maskColor1 = new Color32(255, 0, 255, 255);
